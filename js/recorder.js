...
function getBestMimeType() {
  // Priorizar MP4/AAC — mejor calidad y compatibilidad en Android y PC
  const types = [
    'audio/mp4;codecs=mp4a.40.2',  // AAC-LC — mejor calidad
    'audio/mp4;codecs=mp4a.40.5',  // AAC-HE
    'audio/mp4',
    'audio/aac',
    'audio/mpeg',                   // MP3 nativo (raro en Android)
...
function getFileExtension(mimeType) {
  if (mimeType.includes('mp4')) return 'm4a';  // m4a = AAC en contenedor MP4, compatible con todo
